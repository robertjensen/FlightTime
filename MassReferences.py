...
def MassReferences():
    ...
    masses['H2O'] = [18,12.7775,0.5]
    masses['NH3'] = [17,12.426,0.5]
    masses['OH'] = [17,12.4175,0.5]
    masses['NH2'] = [16,12.058,0.5]
    masses['O'] = [16,12.049,0.5]
    masses['NH'] = [15,11.6818,1.0] #Not 100% sure....
    masses['N'] = [14,11.287,2.5] #Not 100% sure....
    masses['C'] = [12,10.4585,1.5] #Not 100% sure....
    masses['H2'] = [2,4.386,0.5]
    masses['H'] = [1,3.149,0.5]

    mass_ref = np.zeros(len(masses),2)
    i = 0
    for mass in masses:
        mass_ref[i,0] = mass[0]
        mass_ref[i,1] = mass[1]
